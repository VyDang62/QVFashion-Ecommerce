...
<template>
    <div class="grid grid-cols-1 gap-4">
        <div class="z-[30]">
            <label class="text-xs font-bold text-gray-800">Tỉnh / Thành phố <span class="text-md text-red-500">*</span></label>
        ...
        <div class="z-[20]">
            <label class="text-xs font-bold text-gray-800">Quận / Huyện <span class="text-md text-red-500">*</span></label>
            <CustomerSingleSelect 
                v-model="districtId" 
                :options="districts" 
        ...
        <div class="z-[10]">
            <label class="text-xs font-bold text-gray-800">Phường / Xã <span class="text-md text-red-500">*</span></label>
            <CustomerSingleSelect 
                v-model="wardCode" 
                :options="wards" 
