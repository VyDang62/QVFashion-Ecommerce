<template>
  <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
    <div class="flex items-center justify-between mb-4">
      <div>
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Khách hàng mới</h3>
        <p class="text-xs text-gray-500 mt-1">Lượng đăng ký mới năm {{ filters.year }}</p>
      </div>
    ...
    <div class="max-w-full overflow-x-auto custom-scrollbar">
      <div id="chartUsers" class="-ml-5 min-w-[650px] xl:min-w-full pl-2">
