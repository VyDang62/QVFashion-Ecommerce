<template>
  ...
  >
    ...
    <div
      class="px-4 py-6 my-6 overflow-hidden border border-gary-200 rounded-2xl bg-gray-50 sm:px-6"
    >
      <div
        ref="mapOneRef"
        id="mapOne"
    ...
    <div class="space-y-5">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="font-semibold text-gray-800 text-theme-sm">USA</p>
        ...
        <div class="flex w-full max-w-[140px] items-center gap-3">
          ...
          <p class="font-medium text-gray-800 text-theme-sm">79%</p>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="font-semibold text-gray-800 text-theme-sm">France</p>
            <span class="block text-gray-500 text-theme-xs">
              589 Customers
            </span>
          </div>
        ...
        <div class="flex w-full max-w-[140px] items-center gap-3">
          ...
          <p class="font-medium text-gray-800 text-theme-sm">23%</p>
        </div>
      </div>
    </div>
  </div>
