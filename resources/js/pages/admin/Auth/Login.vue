          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              ...
              <div class="mb-5 sm:mb-8">
                <h1 class="mb-2 font-semibold text-gray-800 text-title-sm sm:text-title-md">Đăng nhập</h1>
                <p class="text-sm text-gray-500">Vui lòng điền thông tin để đăng nhập!</p>
              </div>
                  ...
                  <div class="space-y-5">
                    ...
                    <div>
                      <label for="password" class="mb-1.5 block text-sm font-medium text-gray-700">
                        Mật khẩu<span class="text-error-500 text-red-500">*</span>
                      </label>
                      <div class="relative">
                        <input
                          ...
                          class="dark:bg-dark-900 h-11 w-full rounded-lg border bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10"
                    ...
                    <div class="flex items-center justify-between">
                      <div>
                        <label for="remember" class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none">
                          <div class="relative">
                            <input v-model="form.remember" type="checkbox" id="remember" class="sr-only" />
                            <div :class="form.remember ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300'" class="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px]">
                              <span :class="form.remember ? '' : 'opacity-0'">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.6666 3.5L5.24992 9.91667L2.33325 7" stroke="white" stroke-width="1.94437" stroke-linecap="round" stroke-linejoin="round"/></svg>
                              </span>
                            </div>
                          </div>
                          Ghi nhớ đăng nhập
                      ...
                      <Link :href="route('admin.password.request')" class="text-sm text-brand-500 hover:text-brand-600">
                        Quên mật khẩu?
                      </Link>
                    </div>
