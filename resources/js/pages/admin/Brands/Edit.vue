...
<template>
    ...
    <AdminLayout>
        <PageBreadcrumb pageTitle="Chỉnh sửa thương hiệu" parentName="Thương hiệu" :parentRoute="route('admin.brands.index')" />
        ...
        <form @submit.prevent="submit" class="grid grid-cols-1 gap-6 lg:grid-cols-1 gap-6">
            <div class="lg:col-span-8 space-y-6">
                ...
                <SubmitButton :processing="form.processing" label="LƯU THƯƠNG HIỆU" loadingLabel="ĐANG LƯU..." />
            </div>
        </form>
    </AdminLayout>
</template>