...
const form = useForm({
    ...
    is_active: true,
    items: [
        {product_id: null, product_variant_id: null, sale_price: 0, sale_quantity: 0, user_limit: 1}
    ],
});
...
const submit = () => {
    form.post(route('admin.flashsales.store'), {
        preserveScroll: true,
    });
}
...
<template>
    <AdminLayout title="Tạo Flash Sale">
        <Head title="Tạo Flash Sale" />
        <PageBreadcrumb pageTitle="Tạo Flash Sale" parentName="Flash Sale" :parentRoute="route('admin.flashsales.index')" />
        ...
        <form @submit.prevent="submit">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <SubmitButton :processing="form.processing" label="TẠO FLASH SALE" loadingLabel="ĐANG LƯU..." />
                </div>
